...
##Saving the plots
  if(model=="cons"|model=="SS"){
    ggsave(filename=paste("/home/phuong/pCloudDrive/PMA analysis results/figures/fitting/",IS,"_",model,dataInput,site,".png"), plot = mplots)
  }
  if(model=="TV"|model=="TVSS"){
    ggsave(filename=paste("/home/phuong/pCloudDrive/PMA analysis results/figures/fitting/",IS,"_",model,step_year,"yr(s)",dataInput,site,".png"), plot = mplots)
  }

...
setwd("/home/phuong/Dropbox/PMA_Github/PMA_dengue_v2/PMA codes/Code with likelihood calculation")
...
```{r}
if (modelType == "cons"){
  FOI_Dengue <-"~/Dropbox/PMA_Github/PMA_dengue_v2/PMA codes/FoI/Stan/FOI_constant_MLE_Maxine.stan"
}
if (modelType == "SS"){
  FOI_Dengue <-"~/Dropbox/PMA_Github/PMA_dengue_v2/PMA codes/FoI/Stan/FOI_serotype_specific_MLE.stan"
}
if (modelType == "TV"){
  FOI_Dengue <- "~/Dropbox/PMA_Github/PMA_dengue_v2/PMA codes/FoI/Stan/FOI_time varying_MLE_Maxine.stan"
}
if (modelType == "TVSS"){
  FOI_Dengue <-"~/Dropbox/PMA_Github/PMA_dengue_v2/PMA codes/FoI/Stan/FOI_time varying_serotype specific_MLE_Maxine.stan"
}
